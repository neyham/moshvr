 ...
 */
// MODIFIED (moshVR): class opened up (non-final, protected members) so that
// network-backed sessions (e.g. SSH) can subclass it and bypass the local PTY subprocess.
